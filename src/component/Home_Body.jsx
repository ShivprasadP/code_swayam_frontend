const categories = [
  { title: "Events", description: "Gain Practical Experience", image: "/images/card3image.jpg", color: "bg-green-300" },
  { title: "Practice", description: "Refine Skills Daily", image: "/images/card4image.jpg", color: "bg-purple-300" },
  { title: "Bootcamps", description: "Battle For Excellence", image: "/images/card5image.jpg", color: "bg-yellow-300" },
  { title: "More", description: "Explore More Opportunities", image: "/images/crad2image.jpg", color: "bg-pink-300" },
];
    ...
    <div className="p-8 min-h-screen bg-gray-100 flex flex-col md:flex-row items-center">
      ...
      <div className="md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 md:mt-0">
        {categories.map((item, index) => (
          ...
          >
            <img src={item.image} alt={item.title} className="w-25 h-25 rounded-full" />
